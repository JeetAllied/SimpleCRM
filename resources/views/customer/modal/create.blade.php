<form class="form-horizontal ng-pristine ng-valid" action="{{ route('customers.store') }}" method="post" onsubmit="return validateCustomer()">
    @csrf
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="industry" name="industry" placeholder="Enter Industry Name">
            </div>
            <div class="mb-3">
