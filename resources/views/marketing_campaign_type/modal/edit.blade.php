<form class="form-horizontal ng-pristine ng-valid" action="{{ route('marketing-campaign-types.update',$marketingCampaignType->id) }}" method="post" onsubmit="return validateMarketingCampaignType()">
    @csrf
    @method('PUT')
